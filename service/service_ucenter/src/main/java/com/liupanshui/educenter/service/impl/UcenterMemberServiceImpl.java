...
import com.liupanshui.commonutils.MD5;
...
import com.liupanshui.servicebase.config.exceptionHandler.GuliException;
...
//    private UcenterMember ucenterMember;
    ...
    public String login(UcenterMember member) {
        ...
        if(StringUtils.isEmpty(mobile) || StringUtils.isEmpty(password)) {
            throw new GuliException(20001,"请输入手机号和密码，登录失败");
        }
        ...
        //登录成功
        //生成token字符串，使用jwt工具类
        String jwtToken = JwtUtils.getJwtToken(mobileMember.getId(), mobileMember.getNickname(),mobileMember.getRoles());
        return jwtToken;
    }
...
//        User user = ucenterMember.selectByUsername(nickname);
//
//        //根据用户id获取用户菜单权限
